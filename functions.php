...
function twentyseventeen_setup() {
    ...
    // May want to change this later based on framework.
...
//function framework_scripts() {
	// Site dependencies (Bootstrap and theme/global stylesheet).
	//wp_enqueue_style( 'bootstrap-style', get_theme_file_uri( '/bootstrap/css/bootstrap.min.css' ), false, '4.0.0-alpha.6' );
...
//Theme Setup for images
//function imageSetup(){
    // Add feature image support
    //add_theme_support('page-thumbnail');
...
function theme_add_bootstrap() {
	...
	wp_enqueue_script('bootstrap-javascript', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js');
